...
Public Function PreencherAmexSenior( _
    ...
    ' Debug.Print Now() & "C: "& celAtual.Column & celAtual.Row & " - PreencherAmexSenior: dataBase: "& dataBase

    If dataBase = False Then
        PreencherAmexSenior = "Erro data"
        Exit Function
    End If
    ...
    If resultado = False Then
        PreencherAmexSenior = 0
        Exit Function
    End If

    PreencherAmexSenior = resultado

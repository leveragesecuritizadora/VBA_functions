...
Function RetornaCotasAnteriorPagamentoSubordinada( _
    ...
    Debug.Print Now() & "R. cotas - coluna: : "& celAtual.Column & celAtual.Row & " - RetornaCotasAnteriorPagamentoSubordinada: dataBase: "& dataBase

    If dataBase = False Then
        RetornaCotasAnteriorPagamentoSubordinada = "Erro data"
        Exit Function
    End If
    ...
    If resultado = False Then
        RetornaCotasAnteriorPagamentoSubordinada = 0
        Exit Function
    End If

    RetornaCotasAnteriorPagamentoSubordinada = resultado

Attribute VB_Name = "PUCorrigidoSubordinada"
Public Function PreencherPUCorrigidoSubordinada( _
    ...
    ' Debug.Print Now() & "C: "& celAtual.Column & celAtual.Row & " - PreencherPUCorrigidoSubordinada: dataBase: "& dataBase

    If dataBase = False Then
        PreencherPUCorrigidoSubordinada = "Erro data"
        Exit Function
    End If
    ...
    If resultado = False Then
        PreencherPUCorrigidoSubordinada = 0
        Exit Function
    End If

    PreencherPUCorrigidoSubordinada = resultado

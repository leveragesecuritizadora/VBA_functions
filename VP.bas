Attribute VB_Name = "VP"
Function PreencheVP( _
    ...
    Optional nome_fonte As String = "VP" _
) As Variant
    ...
    If wsVP Is Nothing Then
        PreencheVP = "Erro: Tabela '" & nome_fonte & "' n�o existe"
        Exit Function
    End If
    ...
    Else
        PreencheVP = "Erro: c_lula B" & celAtual.Row & " n�o cont_m uma data v�lida"
        Exit Function
    End If
    ...
    If mes_offset < -12 Or mes_offset > 12 Then
        PreencheVP = "Erro: mes_offset fora do intervalo (-12 a 12)"
        Exit Function
    End If
    ...
    PreencheVP = wsVP.Cells(linhaEncontrada, colunaInfo).Value
